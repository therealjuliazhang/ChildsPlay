...
$(document).ready(function() {
			...
			$("#form").validate({
				rules: {
					taskTitle: "required",
                    imageAddress: "required",
					instruction: "required",
                    activityStyle: "required",
                    points: "required"
				},
				messages: {
                    imageAddress: "Please upload an image",
					taskTitle: "Please provide a task title.",
					instruction: "Please provide an instruction for the task.",
					activityStyle: "Please choose an activity style.",
					points: "Please provide points interval for the task"
				},
