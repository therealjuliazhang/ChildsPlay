	...
	<div class="panel-group">
		...
		<div class="panel is-show">
			<div class="container" id="mainContainer">
				<div class="row">
					<!--1st row-->
					<div class="col s12" id="questionCol">
						<h5 class="blue-text darken-2">How does <span id="nameSpan"></span> interact with the image?</h5>
					</div>
					<!--2nd row-->
					<form required>
						<div class="col s3 operationCol">
							<p class="operation">Press:</p>
						</div>
						<div class="col s3 operationCol">
							<p class="operation">Zoom/Pinch:</p>
						</div>
						<div class="col s3 operationCol">
							<p class="operation">Swipe/Drag:</p>
						</div>
						<div class="col s3 operationCol">
							<p class="operation">Other:</P>
						</div>
						<!--3rd row-->
						<form action="#">
							<div class="col s3 operationCol">
						...
						<div class="hide commentSection">
							<div class="col s12" id="commentCol">
								<h5 class="blue-text darken-2">Comment:</h5>
							</div>
