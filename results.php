...
<body>
	...
	<div>
		<li>
			<h5 style="padding-left:18px;">Filter By</h5>
		</li>
	</div>
	<form action="" method="post">
		...
		<ul class="collapsible">
			<li>
				<div class="collapsible-header tabsInSidebar"><i class="material-icons">assessment</i>
					<h6>Tests</h6><i id="arrowForTests" class="material-icons">keyboard_arrow_right</i>
				</div>
		...
		<ul class="collapsible">
			<li>
				<div class="collapsible-header tabsInSidebar"><i class="material-icons">group</i>
					<h6>Group Results</h6><i id="arrowForResults" class="material-icons">keyboard_arrow_right</i>
				</div>
				<div class="collapsible-body">
					<ul class="collapsible">
						<li>
							<div class="collapsible-header tabsInGroupResults">
								<h6 style="padding-left:6px">Location</h6><i id="arrowForLocation" class="material-icons right">keyboard_arrow_right</i>
							</div>
							<div class="collapsible-body">
								<div class="container">
									<!--start checkbox-->
					...
					<ul class="collapsible">
						<li>
							<div class="collapsible-header tabsInGroupResults">
								<h6 style="padding-left:6px">Group</h6><i id="arrowForGroup" class="material-icons right">keyboard_arrow_right</i>
							</div>
							<div class="collapsible-body">
								<div class="container">
									<!--start checkbox-->
					...
					<ul class="collapsible">
						<li>
							<div class="collapsible-header tabsInGroupResults">
								<h6 style="padding-left:6px">Gender</h6><i id="arrowForGender" class="material-icons right">keyboard_arrow_right</i>
							</div>
							<div class="collapsible-body">
								<div class="container">
									<!--start checkbox-->
					...
					<ul class="collapsible">
						<li>
							<div class="collapsible-header tabsInGroupResults">
								<h6 style="padding-left:6px">Age</h6><i id="arrowForAge" class="material-icons right">keyboard_arrow_right</i>
							</div>
							<div class="collapsible-body">
								<div class="container">
									<?php
		...
		<ul class="collapsible">
			<li>
				<div class="collapsible-header tabsInSidebar"><i class="material-icons">person</i>
					<h6>Individual Results</h6><i id="arrowForIndividualResults" class="material-icons right">keyboard_arrow_right</i>
				</div>
				<div class="collapsible-body">
					<div class="container">
						<?php
...
<div id="body">
	<!--end slide out menu-->
	<div class="tooltipped" data-position="left" data-tooltip="Export data as CSV file." align="right" style="position:fixed;top:80px;right:25px"><a href="exportData.php"><img src="images/Excel-2-icon.png" width="40px" height="40px" /></a></div>
	<div id="results">
	</div>
</div>
<!--end body content-->
