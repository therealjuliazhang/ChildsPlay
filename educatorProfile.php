...
<div class="container" id="userDetail">
   ...
   <div class="row">
     <div class="col s6 blue-text darken-2 column01"><h5>Personal Information</h5></div>
   </div>
   <div class="row">
   ...
   <div class="row">
     ...
     <div class="col s1"><a class="waves-effect waves-light btn right" id="removeButton" onclick="removeRow()"><i class="material-icons">remove</i></a></div>
   </div>
  ...
  <!--Edit and Save information function-->
    ...
    function appendSelect() {
            ...
            var locations = "<div class='row'><div class='col s2'></div><div class='input-field col s9' class='selectLocation' disabled><select><option value='1' disabled selected>Choose location<option>"
